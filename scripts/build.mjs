...
// Projekt-Hauptverzeichnis korrekt für Windows / Linux / macOS ermitteln
...
// Lokale TypeScript-Installation verwenden.
// Das ist unter Windows zuverlässiger als execFileSync("tsc", ...)
...
cpSync(
  join(build, "popup", "index.js"),
  join(dist, "popup.js")
);

cpSync(
  join(build, "background", "index.js"),
